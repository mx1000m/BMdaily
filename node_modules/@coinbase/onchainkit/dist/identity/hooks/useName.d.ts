import { GetNameReturnType, UseNameOptions, UseQueryOptions } from '../types';
/**
 ...
 */
export declare const useName: ({ address, chain }: UseNameOptions, queryOptions?: UseQueryOptions<GetNameReturnType>) => import('@tanstack/react-query').UseQueryResult<GetNameReturnType, Error>;
