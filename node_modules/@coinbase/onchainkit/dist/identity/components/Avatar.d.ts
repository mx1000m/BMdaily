 ...
 */
export declare function Avatar({ address, chain, className, defaultComponent, loadingComponent, children, ...props }: AvatarReact): import("react/jsx-runtime").JSX.Element | null;
