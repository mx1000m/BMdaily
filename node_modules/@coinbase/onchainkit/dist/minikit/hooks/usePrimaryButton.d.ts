import { SetPrimaryButtonOptions } from '@farcaster/frame-sdk';
/**
 ...
 * @returns void
 */
export declare function usePrimaryButton(options: SetPrimaryButtonOptions, callback: () => void): void;
//# sourceMappingURL=usePrimaryButton.d.ts.map