...
function CheckoutStatus({ className }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("flex justify-between", className), children: /* @__PURE__ */ jsx("div", { className: text.label2, children: /* @__PURE__ */ jsx("p", { className: labelClassName, children: label }) }) });
}
export {
  CheckoutStatus
};
