...
function CheckoutButton({
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      type: "button",
      disabled: isDisabled,
      children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center whitespace-nowrap", children: isLoading ? /* @__PURE__ */ jsx(Spinner, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
        shouldRenderIcon && /* @__PURE__ */ jsx("div", { className: "mr-2 flex h-5 w-5 shrink-0 items-center justify-center", children: iconSvg }),
        /* @__PURE__ */ jsx(
          "span",
          {
            className: cn(
