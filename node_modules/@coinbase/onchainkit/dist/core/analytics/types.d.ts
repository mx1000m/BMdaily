 ...
 */
export declare enum AppchainEvent {
 ...
 */
export type AnalyticsEvent = AppchainEvent | WalletEvent | SwapEvent | BuyEvent | CheckoutEvent | MintEvent | TransactionEvent | FundEvent | EarnEvent | ErrorEvent;
/**
