...
function useGetTransactionToastAction() {
  ...
  return useMemo(() => {
    ...
    if (errorMessage) {
      actionElement = /* @__PURE__ */ jsx("button", { type: "button", onClick: onSubmit, children: /* @__PURE__ */ jsx("span", { className: cn(text.label1, color.primary), children: "Try again" }) });
    }
