...
function useLogo({
  ...
  const svgLogo = useMemo(() => {
    ...
    return /* @__PURE__ */ jsxs("g", { transform: `translate(${logoPosition}, ${logoPosition})`, children: [
      /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("clipPath", { id: "clip-logo", children: /* @__PURE__ */ jsx(
        "rect",
        {
          width: logoSize,
          height: logoSize,
      ...
      /* @__PURE__ */ jsx("g", { transform: `translate(${logoMargin}, ${logoMargin})`, children: /* @__PURE__ */ jsx(
        "image",
        {
