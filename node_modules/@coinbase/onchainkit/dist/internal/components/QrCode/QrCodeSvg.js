...
function QrCodeSvg({
  ...
  return /* @__PURE__ */ jsxs("svg", { viewBox, width: size, height: size, children: [
    /* @__PURE__ */ jsx("title", { children: "QR Code" }),
    /* @__PURE__ */ jsx("defs", { children: isRadialGradient ? /* @__PURE__ */ jsx(
      "radialGradient",
      {
        id: `radialGrad-${uid}`,
        ...
        children: presetGradientForColor.map(([gradientColor, offset]) => /* @__PURE__ */ jsx(
          "stop",
          {
            offset,
      ...
      "linearGradient",
      {
        ...
        gradientUnits: "userSpaceOnUse",
        children: [
          /* @__PURE__ */ jsx("stop", { offset: "0", stopColor: linearColors[0] }),
          /* @__PURE__ */ jsx("stop", { offset: "1", stopColor: linearColors[1] })
        ]
      }
    ) }),
