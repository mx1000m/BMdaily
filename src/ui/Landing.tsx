				...
				<div className="wallet-row">
					{isConnected ? (
						<div className="wallet-address">
                            <SafeIdentityCard apiKey={(import.meta.env.VITE_ONCHAINKIT_API_KEY as string) || (import.meta.env.VITE_ONCHAINKIT_CLIENT_KEY as string) || 'YpFjb8rh9RuzhmGWxT9kPZ1vVfRaAXym'} address={(address || '0x') as `0x${string}`} />
						</div>
					) : (
                        <SafeWalletShell apiKey={(import.meta.env.VITE_ONCHAINKIT_API_KEY as string) || (import.meta.env.VITE_ONCHAINKIT_CLIENT_KEY as string) || 'YpFjb8rh9RuzhmGWxT9kPZ1vVfRaAXym'} />
					)}
				</div>
