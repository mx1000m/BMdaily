				...
				<div className="wallet-row">
					{isConnected ? (
						<div className="wallet-address">
                            <SafeIdentityCard apiKey={import.meta.env.VITE_ONCHAINKIT_API_KEY as string} address={(address || '0x') as `0x${string}`} />
						</div>
					) : (
                        <SafeWalletShell apiKey={import.meta.env.VITE_ONCHAINKIT_API_KEY as string} />
					)}
				</div>
